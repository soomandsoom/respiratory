...
function mouseClicked() {
  ...
  let shapeB = new Shape(random(350,1380), random(240,850), 10, color(0, 0, 0)); 
  let shapeC = new Shape(random(350,1380), random(240,850), 10, color(0, 0, 0)); 
  let shapeD = new Shape(random(350,1380), random(240,850), 10, color(0, 0, 0));
  stroke(1);
