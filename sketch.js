...
function mouseClicked() {
  ...
  let shapeB = new Shape(random(200,1280), random(240,950), 10, color(0, 0, 0)); 
  let shapeC = new Shape(random(200,1280), random(240,950), 10, color(0, 0, 0)); 
  let shapeD = new Shape(random(200,1280), random(240,950), 10, color(0, 0, 0));
  stroke(1);
